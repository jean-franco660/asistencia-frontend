            ...
            <div class="space-y-2">
              ...
              <div class="relative group">
                ...
                <input
                  ...
                  class="w-full pl-12 pr-12 py-3.5 bg-slate-50 dark:bg-slate-800/50 border-2 border-slate-200 dark:border-slate-700 rounded-xl text-slate-900 dark:text-slate-100 placeholder-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 outline-none"
                  :class="{
                    'border-red-500 focus:border-red-500 focus:ring-red-500/10':
                      errors.password,
                  }"
