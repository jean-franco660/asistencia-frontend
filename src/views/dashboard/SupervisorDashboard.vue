    ...
    <div class="max-w-7xl mx-auto space-y-8">
      ...
      <div class="grid gap-6 grid-cols-1 lg:grid-cols-3">
        ...
        >
          ...
          ></div>
          <div
            class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-full blur-3xl"
          ></div>
        ...
        >
          <div
            class="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 dark:from-indigo-600/20 dark:to-purple-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          ></div>

          <div class="relative p-6">
            <div class="flex items-start justify-between mb-4">
              <div
                class="p-3 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-500"
              >
                <svg
                  class="w-6 h-6 text-white"
                  fill="none"
            ...
            <div>
              ...
              >
                {{ loading ? "—" : stats.total_instituciones }}
              </h3>
            </div>
          </div>
        </div>
      ...
      <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <div class="relative p-6">
            ...
            <div>
              ...
              <h3
                class="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent"
              >
        ...
        >
          ...
          <div class="relative p-6">
            ...
            <div>
              ...
              <h3
                class="text-4xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 bg-clip-text text-transparent"
              >
                {{ loading ? "—" : stats.asistencias_hoy }}
              </h3>

              <!-- Barra de progreso -->
              <div v-if="!loading && stats.docentes > 0" class="mt-3">
                <div class="flex items-center justify-between text-xs mb-1.5">
                  <span class="text-gray-500 dark:text-gray-400">Asistencia</span>
                ...
                >
                  <div
                    class="absolute inset-y-0 left-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full transition-all duration-1000 ease-out"
        ...
        >
          <div
            class="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-red-500/10 dark:from-orange-600/20 dark:to-red-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          ></div>

          <div class="relative p-6">
            <div class="flex items-start justify-between mb-4">
              <div
                class="p-3 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-500"
              >
                <svg
                  class="w-6 h-6 text-white"
                  fill="none"
              ...
              <span
                class="px-2 py-1 bg-orange-100 dark:bg-orange-900/50 text-orange-700 dark:text-orange-300 rounded-full text-xs font-semibold"
              >
                Hoy
              </span>
            </div>
            ...
            <div>
              ...
              <h3
                class="text-4xl font-bold bg-gradient-to-r from-orange-600 to-red-600 dark:from-orange-400 dark:to-red-400 bg-clip-text text-transparent"
              >
                {{ loading ? "—" : stats.ausencias_hoy }}
              </h3>
            </div>
          </div>
        </div>

        <!-- Justificaciones Pendientes Card -->
        <div
          class="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1"
          :class="{ 'animate-pulse': loading }"
        >
          <div
            class="absolute inset-0 bg-gradient-to-br from-amber-500/10 to-yellow-500/10 dark:from-amber-600/20 dark:to-yellow-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          ></div>

          <div class="relative p-6">
            <div class="flex items-start justify-between mb-4">
              <div
                class="p-3 bg-gradient-to-br from-amber-500 to-yellow-600 rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-500"
              >
                <svg
                  class="w-6 h-6 text-white"
                  fill="none"
              ...
              <span
                v-if="!loading && stats.justificaciones_pendientes > 0"
                class="px-2 py-1 bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300 rounded-full text-xs font-semibold animate-pulse"
              >
                Requiere atención
              </span>
            </div>
            ...
            <div>
              ...
              <h3
                class="text-4xl font-bold bg-gradient-to-r from-amber-600 to-yellow-600 dark:from-amber-400 dark:to-yellow-400 bg-clip-text text-transparent"
              >
                {{ loading ? "—" : stats.justificaciones_pendientes }}
              </h3>
            </div>
          </div>
        </div>
      ...
      <div
        v-if="!loading"
        class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 dark:border-gray-700/50 p-8"
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            class="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-2xl"
          >
            ...
            <div>
              <p class="text-xs text-gray-500 dark:text-gray-400">Total Marcaciones</p>
              <p class="text-2xl font-bold text-gray-900 dark:text-white">
                {{ stats.registros_asistencia_hoy }}
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              <p class="text-xs text-gray-500 dark:text-gray-400">Asistencia Completa</p>
              <p class="text-2xl font-bold text-gray-900 dark:text-white">
                {{ stats.asistencias_hoy }} / {{ stats.docentes }}
              </p>
            </div>
          </div>
...
const loadStats = async () => {
  ...
  try {
    ...
    stats.value = {
      institucion:
        data.instituciones && data.instituciones.length > 0
          ? data.instituciones[0].nombre
          : "No asignada",
      codigo_modular:
        data.instituciones && data.instituciones.length > 0
          ? data.instituciones[0].codigo_modular
          : "",
