...
const confirmLogout = async () => {
  console.log("[LOG] Iniciando logout");

  // Cerrar el menú primero
  showUserMenu.value = false;

  try {
    console.log("[LOG] Mostrando confirmación...");
    ...
    console.log("[LOG] Resultado de confirmación:", result);

    if (!result.isConfirmed) {
      console.log("[LOG] Usuario canceló el logout");
      return;
    }

    console.log("[LOG] Ejecutando logout...");
    ...
    console.log("[LOG] Logout exitoso");
    ...
    // Redirigir al login
    console.log("[LOG] Redirigiendo a login...");
    await router.push("/login");

    console.log("[LOG] Proceso de logout completado");
  } catch (error) {
